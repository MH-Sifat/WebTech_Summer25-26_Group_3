...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($valid) {
        ...
        $result = $database->jobPost($connection, "job_postings", $employer_id, $title, $description, $requirements, $location, $jobType, $salary, $deadline);
        
        if ($result) {
            echo "Job posted successfully!<br>";
        }
    }
